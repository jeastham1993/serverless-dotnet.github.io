...
const config = {
  ...
  projectName: 'serverlessdotnet.github.io', // Usually your repo name.
  trailingSlash: false,
  ...
  themeConfig:
    ...
    ({
      metadata: [{
        name: 'keywords', content: '.NET, serverless, aws, aws lambda, dotnet'
      }],
      navbar: {
        title: 'Serverless .NET',
        items: [
          ...
          {
            href: 'https://github.com/jeastham1993/serverless-dotnet.github.io',
            label: 'GitHub',
            position: 'right',
          },
        ],
